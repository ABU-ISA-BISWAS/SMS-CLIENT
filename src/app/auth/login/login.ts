...
export class Login implements OnInit, AfterViewInit {
  ...
  isLoadingStatus(): void {
    this.authService.loadingStatus().subscribe((isLoading: boolean) => this.isLoading = isLoading);
  }
  ...
  async getCompany(){
    ...
    if(this.companyInfo){
      ...
      localStorage.setItem("companyClassName", this.companyInfo.companyClassName);
